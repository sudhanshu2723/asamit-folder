            ...
            <Modal.Content className="!rounded-3xl">
                    ...
                    >
                        ...
                        >
                            <ActionIcon
                                ...
                                component="a"
                                href="https://drive.google.com/uc?export=download&id=1JOLqVal_kT_ZsSAFjsw8_5M7LxHui7gL"
                                size={btn}
                                download={Info.name}
                                variant="outline"
                                color="#64FFDA"
                ...
                <Modal.Body className="!bg-bgColor xs-mx:!p-2 !pt-2 !border-primaryColor !border-2 xs-mx:!border xs-mx:!border-t-0 !border-t-0 !rounded-bl-3xl !rounded-br-3xl">
                    <Document
                        ...
                        file="https://drive.google.com/uc?export=download&id=1JOLqVal_kT_ZsSAFjsw8_5M7LxHui7gL"
                    >
                        <Page
